          ...
          {projects.map((project, index) => {
            ...
            const textColumn = (
              <div className="space-y-6">
                <div>
                  <h3 className="text-3xl md:text-4xl lg:text-5xl font-light mb-4 tracking-wide" style={{ color: '#D9A96A' }}>
                    {project.title}
                  </h3>
                  <p className="text-sm mb-6 font-light tracking-wide uppercase" style={{ color: '#D9A96A', opacity: 0.75 }}>
                    {project.org}
                  </p>
                </div>

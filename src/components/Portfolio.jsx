...
export default function Portfolio() {
  ...
  return (
    <section ref={sectionRef} id="portfolio" className="relative z-10 min-h-screen py-20 px-4 sm:px-6 md:px-8 overflow-visible bg-transparent -mt-20">
          ...
          {projects.map((project, index) => {
            ...
            const textColumn = (
              <div className="space-y-6">
                  <div>
                  <h3 className="text-3xl md:text-4xl lg:text-5xl font-light mb-4 tracking-wide text-white">
                      {project.title}
                    </h3>
                  <p className="mono text-xs mb-6 tracking-widest uppercase" style={{ color: 'var(--accent-dim)' }}>
                      {project.org}
                    </p>
                  </div>
                ...
                {/* Links at bottom of text column */}
                  <div className="flex flex-col gap-3 mt-8">
                    {project.github && (
                      ...
                      className="inline-flex items-center gap-3 text-sm font-light transition-opacity hover:opacity-100 opacity-70"
                  ...
                  <div className="w-full aspect-video overflow-hidden rounded-lg flex items-center justify-center p-8">
                    ...
                    <div className="flex flex-wrap gap-2 mt-4">
                      {project.tech.map((tech, idx) => (
                        <span key={idx} className="mono px-2 py-1 text-xs" style={{ color: 'var(--accent-dim)', border: '1px solid var(--border)' }}>
                          {tech}
                        </span>
                      ))}
                    </div>
